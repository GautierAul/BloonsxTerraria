...
using BloonsxTerraria.Items.Ammo;
using BloonsxTerraria.Items.Drop;

namespace BloonsxTerraria.Items.Weapons
{
	public class TripleDart : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Shoot three dart at the same time !");
		...
		{
			CreateRecipe()
				.AddIngredient<SimpleDartAmmo>(3)
				.AddIngredient<Rubber>(5)
		...
		{
			type = ModContent.ProjectileType<Projectiles.SimpleDartProjectile>();
		}
