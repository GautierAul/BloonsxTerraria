...
namespace BloonsxTerraria.NPC
{
	...
	public class RainbowBloon : ModNPC
	{
		public override string Texture => "BloonsxTerraria/NPC/Bloons";

		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Rainbow Bloon");
		...
		public override bool PreKill()
        {
			...
			Terraria.NPC.NewNPC(NPC.GetSource_FromAI(), (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<ZebraBloon>());
			int bloon2 = Terraria.NPC.NewNPC(NPC.GetSource_FromAI(), (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<ZebraBloon>());
