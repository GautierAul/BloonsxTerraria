...
namespace BloonsxTerraria.NPC
{
	...
	public class ZebraBloon : ModNPC
	{
		public override string Texture => "BloonsxTerraria/NPC/Bloons";

		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Zebra Bloon");
		...
		public override bool PreKill()
        {
			...
			int bloon2 = Terraria.NPC.NewNPC(NPC.GetSource_FromAI(), (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<WhiteBloon>());
        ...
        {
			return SpawnCondition.SurfaceJungle.Chance * 0.10f;
        }
